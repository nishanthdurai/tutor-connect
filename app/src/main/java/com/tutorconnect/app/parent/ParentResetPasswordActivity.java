        ...
        btn_reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.equals("")) {
                    ...
                    Query emailQuery = dbInstance.child("parents").orderByChild("email").equalTo(email);
                    emailQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            if (dataSnapshot.exists()) {
                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                    ...
                                    if (parent != null) {
                                        sendEmail(email,
                                                "Your login password",
                                                "Your password for logging in is: " + parent.getPassword());
                                    }
                                }
                            } else {
                                progressDialog.dismiss();
                                Toast.makeText(ParentResetPasswordActivity.this, "Email is not registered, " + "try signing up..!", Toast.LENGTH_SHORT).show();
                            }
                        }
                        ...
                        public void onCancelled(@NonNull DatabaseError databaseError) {
                            ...
                            Toast.makeText(ParentResetPasswordActivity.this, "Error validating email, " + "try again later..!", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                ...
                if (result) {
                    ...
                    Toast.makeText(ParentResetPasswordActivity.this, "Failed to send email", Toast.LENGTH_SHORT).show();
                }
            });
        }).start();
    }
